...
parser.add_argument('--e', default=1, type=int, help='no of epochs') 
...
def train_model(model, device, norm, start_epoch, epochs, batch_size, learning_rate):
    ...
    train_loader, test_loader = dataloaders("CIFAR10", train_batch_size=batch_size, val_batch_size=batch_size)
...
# def main(lr = 0.007, batch_size = 128, epochs = 5, norm = "batch", n = 10, resume = False): --> use this for Colab
